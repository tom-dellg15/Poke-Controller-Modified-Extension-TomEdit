...
#from Commands.PythonCommands.SwordShield.util_Switch_Poke import util_Switch_Poke
...
class AutoHatching_pkmnSWSH(util_Switch_Poke):
    ...
    def do(self):   
        ...
        while True:
            ...
            if self.shiny_flag:
                ...
                self.LINE_image("*** 色違い発見：" + str(self.shiny_count) + "/" + str(self.shiny_max) + " ***") # LINE通知
                # 色違い取得最大数に達するまで続ける
    ...
    def getEggFromBreeder(self):
        ...
        while not self.isContainTemplate("egg_found.png"):
            self.wait(1.0)
            ...
            for j in range(0, col):
                ...
                if self.isContainTemplate('shiny_mark.png', threshold=0.9):
                    ...
                    if i % 2 == 0:
                        ...
                        shiny_col = col - j - 1
                    self.LINE_image("★★★shiny!（" + str(self.egg_num_total) + "匹目）★★★")   # LINE通知
