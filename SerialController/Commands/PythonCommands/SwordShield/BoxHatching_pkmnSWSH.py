...
class BoxHatching_pkmnSWSH(ImageProcPythonCommand):
    NAME = '【剣盾】ボックス内卵孵化'
#当初処理
...
#            print('hatched_num: ' + str(self.hatched_num))
    ...
    def do(self):
            ...
            while True:
                ...
                if self.egg_row == 0:
                    ...
                    for i in range(0, 6):
                        ...
                        if self.isContainTemplate("egg_status.png", threshold=0.9): #★スクショとる必要あり
                            self.egg_row += 1
                ...
                for i in range(0, 5):
                    ...
                    if self.isContainTemplate("on_hand_egg.png", threshold=0.9):    # ★スクショとる必要あり
                        self.egg_on_hand += 1
                    else:
                        break
        ...
        self.LINE_image("*** 孵化作業完了。孵化総合計：" + str(self.egg_total) + " ***") # LINE通知
